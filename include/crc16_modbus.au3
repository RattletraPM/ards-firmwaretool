; =======================================================
; Function      _Crc16
; Purpose:      Return the crc16 checksum of the input value
; Author:       'roby' at http://www.autoitscript.com/forum
; =======================================================
Func _Crc16($value)
    $value = Binary($value)
    Local $crc = 0xFFFF, $tmp
    Local $table[256] = [ _
    ...
    For $i = 1 To BinaryLen($value)
        $crc = BitXOR(BitShift($crc, 8), $table[BitAND(BitXOR($crc, BinaryMid($value, $i, 1)), 0xFF)])
    Next
    Return Binary("0x"&Hex($crc, 4))
EndFunc   ;==>_Crc16